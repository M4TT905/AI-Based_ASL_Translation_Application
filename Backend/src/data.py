...
class DETRData(Dataset): 
    ...
    def __getitem__(self, idx): 
        ...
        image_path_jpg = os.path.join(self.images_path, f'{self.image_name}.jpg')
        image_path_jpeg = os.path.join(self.images_path, f'{self.image_name}.jpeg')
        
        if os.path.exists(image_path_jpg):
            self.image_path = image_path_jpg
        elif os.path.exists(image_path_jpeg):
            self.image_path = image_path_jpeg
        else:
            raise FileNotFoundError(f"Image not found: {self.image_name} (.jpg or .jpeg)")
