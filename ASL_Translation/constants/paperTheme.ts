...
// Based on MD3DarkTheme so all un-overridden container/surface tokens are dark,
// preventing white-text-on-light-surface unreadability.
export const highContrastTheme = {
  ...
  colors: {
    ...
    secondaryContainer: '#001a1a', onSecondaryContainer: '#00ffff',
    tertiary: '#ff00ff',         onTertiary: '#000000',
    tertiaryContainer: '#1a001a', onTertiaryContainer: '#ff00ff',
    error: '#ff6b6b',            onError: '#000000',
    errorContainer: '#1a0000',   onErrorContainer: '#ff6b6b',
    background: '#000000',       onBackground: '#ffffff',
    surface: '#000000',          onSurface: '#ffffff',
    surfaceVariant: '#1a1a1a',   onSurfaceVariant: '#ffffff',
    outline: '#ffffff',          outlineVariant: '#444444',
    inverseSurface: '#ffffff',   inverseOnSurface: '#000000',
    inversePrimary: '#333300',
  },
  roundness: 12,
};
